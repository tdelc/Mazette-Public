  ...
  layout_sidebar(
    sidebar = sidebar(
      ...
      div(class = "small text-muted",
          ...
          "= CA + autres produits", tags$br(),
          "− matières − rémunérations − frais généraux", tags$br(),
          "+ résultat financier",
          tags$br(), tags$br(),
          "L'amortissement est écarté : c'est une écriture, pas une sortie de",
          " caisse, et il ne se pilote pas au mois. Le résultat financier est",
          " inclus : les intérêts, eux, se paient.",
          tags$br(), tags$br(),
